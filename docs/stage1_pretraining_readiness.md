...
| **Fall Detection Dataset (State-to-Fall + ADL)** | `3: fall`<br/>(`0: person`) | 54 MP4 video clips<br/>(~3,000–5,000 frames) | **10 video clips**<br/>(487 extracted frames) | • 100% of CVAT-annotated clips (8 clips: 6 standing_to_fall, 2 sleeping_to_fall).<br/>• 2 unannotated spot-checks (1 sitting_to_fall, 1 ADL negative control).<br/>• 7 actor/session clusters mapped in [fall_actor_grouping.csv](audit_artifacts/fall/fall_actor_grouping.csv). | **EXECUTED**<br/>(Passed Sample Audit; 4 remediation discrepancies cataloged in [fall_discrepancy_log.md](audit_artifacts/fall/fall_discrepancy_log.md)) |
